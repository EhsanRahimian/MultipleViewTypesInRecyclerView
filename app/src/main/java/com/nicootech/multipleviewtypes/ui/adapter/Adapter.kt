package com.nicootech.multipleviewtypes.ui.adapter
...
import com.nicootech.multipleviewtypes.ui.adapter.item.TypeAViewHolder
import com.nicootech.multipleviewtypes.ui.adapter.item.TypeBViewHolder
import com.nicootech.multipleviewtypes.ui.adapter.item.TypeCViewHolder
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ViewHolderType.TYPE_A.ordinal -> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.view_holder_type_a,parent, false)
                return TypeAViewHolder(view)
            }
            ViewHolderType.TYPE_B.ordinal-> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.view_holder_type_b,parent, false)
                return TypeBViewHolder(view)

            }
            ViewHolderType.TYPE_C.ordinal-> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.view_holder_type_c,parent, false)
